# M05A : TimeInterval、GantryFrom、GantryTo、VehicleType、SpaceMeanSpeed、Traffic

# 資料夾路徑 : /workspaces/cycu_ai2024/20240430/SpaceMeanSpeed
...
# 將特徵保存到 CSV 檔案
df.to_csv('/workspaces/cycu_ai2024/20240507/11272009_2.csv', index=False)
